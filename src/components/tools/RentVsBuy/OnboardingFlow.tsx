          ...
          <div className="step-content">
            <div className="input-group">
              ...
              <div className="button-group">
                ...
                >
                   <span className="option-icon">Hot</span>
                  <span className="option-text">
                ...
                >
                   <span className="option-icon">Cool</span>
                  <span className="option-text">
            ...
            <div className="input-group">
              ...
              <div className="button-group">
                ...
                >
                   <span className="option-icon">Chart</span>
                  <span className="option-text">
            ...
            <div className="input-group">
              ...
              <div className="button-group">
                ...
                >
                   <span className="option-icon">Timer</span>
                  <span className="option-text">
                ...
                >
                   <span className="option-icon">Clock</span>
                  <span className="option-text">
                ...
                >
                   <span className="option-icon">Calendar</span>
                  <span className="option-text">
